...
use Core\Foundation\JWT\JWT as JWTHelper;
...
//        } elseif ($request->cookie(JWTHelper::cookie())) {
//            return $this->authenticateViaCookie($request);
//        }
        if ($request->cookie(JWTHelper::cookie())) {
            return $this->authenticateViaCookie($request);
        }
    }
...
//    }
    ...
    protected function decodeJwtTokenCookie($request)
    {
        return (array) JWT::decode(
            $this->encrypter->decrypt($request->cookie(JWTHelper::cookie())),
